    ...
    <div class="container">
        ...
        <form action="validation.php" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="PRO_lib" name="PRO_lib"
                    value="<?php echo $produit['PRO_lib'] ?>" required>
            </div>

            <div class="form-group">
                <label for="PRO_description">Description</label>
                <textarea class="form-control" id="PRO_description" name="PRO_description"
                    rows="10"><?php echo $produit['PRO_description'] ?></textarea>
            </div>

            <div class="form-group">
                <label for="PRO_prix">Prix (€)</label>
                <input type="number" class="form-control text-right" id="PRO_prix" name="PRO_prix"
                    value="<?php echo $produit['PRO_prix'] ?>" step="0.01" min="0" required>
            </div>
            ...
            <div class="form-group">
                ...
                <input type="file" id="PRO_ressources" name="PRO_ressources[]" multiple class="form-control"
